...
<section className="">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-white bg-black-gradient-2 rounded-lg border border-gray-100 shadow border-gray-600 xl:p-8 bg-gray-800 text-white">
          <h3 class="mb-4 font-poppins font-semibold text-[33px] leading-[32px] text-white">Herman Jensen</h3>
              <p className="font-poppins font-normal text-dimWhite text-[18px] leading-[30.8px] text-white sm:text-lg text-white">Best option for personal use & for your next project.</p>
...
<Button />          </div>
          ...
          <h3 class="mb-4 font-poppins font-semibold text-[33px] leading-[32px] text-white">Herman Jensen</h3>
              ...
              <div className="flex justify-center items-baseline my-8">
                  ...
                  <span className="text-white text-white" text-white>/month</span>
              </div>
              <ul role="list" className="mb-8 space-y-4 text-left">
                  <li className="flex items-center space-x-3">
                      <svg className="flex-shrink-0 w-5 h-5 text-cyan-400 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
